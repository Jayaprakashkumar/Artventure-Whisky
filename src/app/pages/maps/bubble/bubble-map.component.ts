  ...
  constructor(private theme: NbThemeService,
    ...
    combineLatest([
      ...
      .subscribe(([map, config]: [any, any]) => {
        ...
        this.mapData = [
          { 'code': 'MC', 'name': 'Manaco', 'value': 2, 'color': this.getRandomGeoColor() },
          { 'code': 'AT', 'name': 'Austria', 'value': 16, 'color': this.getRandomGeoColor() },
          { 'code': 'BE', 'name': 'Belgium', 'value': 1, 'color': this.getRandomGeoColor() },
          { 'code': 'DK', 'name': 'Denmark', 'value': 1, 'color': this.getRandomGeoColor() },
          { 'code': 'FR', 'name': 'France', 'value': 12, 'color': this.getRandomGeoColor() },
          { 'code': 'DE', 'name': 'Germany', 'value': 28, 'color': this.getRandomGeoColor() },
          { 'code': 'HK', 'name': 'Hong Kong, China', 'value': 5, 'color': this.getRandomGeoColor() },
          { 'code': 'IT', 'name': 'Italy', 'value': 8, 'color': this.getRandomGeoColor() },
          { 'code': 'KR', 'name': 'South Korea(Rep of Korea)', 'value': 3, 'color': this.getRandomGeoColor() },
          { 'code': 'NL', 'name': 'Netherlands', 'value': 2, 'color': this.getRandomGeoColor() },
          { 'code': 'PT', 'name': 'Portugal', 'value': 2, 'color': this.getRandomGeoColor() },
          { 'code': 'SE', 'name': 'Sweden', 'value': 8, 'color': this.getRandomGeoColor() },
          { 'code': 'CH', 'name': 'Switzerland', 'value': 18, 'color': this.getRandomGeoColor() },
          { 'code': 'TW', 'name': 'Taiwan(Rep of China)', 'value': 1, 'color': this.getRandomGeoColor() },
          { 'code': 'GB', 'name': 'United Kingdom', 'value': 83, 'color': this.getRandomGeoColor() },
          { 'code': 'US', 'name': 'United States', 'value': 470, 'color': this.getRandomGeoColor() },
        ]
